		...
		if (_v0.$ === 'Nothing') {
			...
			var js = function () {
				...
				if (_v2.$ === 'Just') {
					...
					var _v3 = A2($elm$core$Debug$log, 'Oops, invalid pawnSwap?', _Utils_Tuple0);
					return gs;
				}
			}();
			var hs = A2(
...
var $author$project$Logic$playPawn = F3(
	function (p, roll, gs) {
		var n = p.square;
		var moveToRebirth = function (_v6) {
			return A2(
				$elm$core$Maybe$andThen,
				function (d) {
			...
			if (!legalSqType) {
				...
				if (skippedHappiness) {
					...
					if (attemptedLeave) {
						...
						var _v1 = A2($author$project$BoardTree$getElem, m, gs.board);
						if (_v1.$ === 'Nothing') {
							var _v2 = A2($elm$core$Debug$log, 'Yikes, out-of-bounds m not handled...', m);
							return $elm$core$Maybe$Nothing;
						} else {
							var dest = _v1.a;
							var _v3 = $author$project$Board$squareType(m);
							if ((_v3.$ === 'Spec') && (_v3.a.$ === 'Water')) {
								var _v4 = _v3.a;
								return moveToRebirth(_Utils_Tuple0);
							} else {
								return moveTo(dest);
			...
			var expect = function () {
				var expHelper = F3(
					function (acc, weights, moves) {
						...
						var _v8 = $elm$core$Debug$log('Problem taking expectation...');
						return $elm$core$Maybe$Nothing;
					});
				return A2(
					expHelper,
		...
		if (!legalSqType) {
			...
			if (skippedHappiness) {
				...
				if (attemptedLeave) {
					...
					if (_v0.$ === 'Nothing') {
						var _v1 = A2($elm$core$Debug$log, 'Yikes, out-of-bounds m not handled...', m);
						return false;
					} else {
						if (_v0.a.$ === 'Free') {
							var _v2 = _v0.a;
						...
						A2(
							...
							function (roll) {
								var ts = function () {
									...
									var _v14 = A2(
										$elm$core$Debug$log,
										'stored ts\'s gs == current gs?',
										_Utils_eq(gs, model.gs));
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$Debug$toString(x + 1)),
								$elm$svg$Svg$Attributes$cy(
								$elm$core$Debug$toString(y + 50)),
								$elm$svg$Svg$Attributes$r(
								$elm$core$Debug$toString(rlen)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'0 0 ' + ($elm$core$Debug$toString(width) + ' 100'))
				]),
			A2(
				$elm$core$List$cons,
				outline,
				...
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$cx(
								$elm$core$Debug$toString(x + ((slen / 2) | 0))),
								$elm$svg$Svg$Attributes$cy(
								$elm$core$Debug$toString(y + ((slen / 2) | 0))),
								$elm$svg$Svg$Attributes$r(
								$elm$core$Debug$toString(((2 * slen) / 7) | 0)),
								$elm$svg$Svg$Attributes$stroke('black'),
								$elm$svg$Svg$Attributes$fill(
...
var $author$project$Sticks$retLight = function (b) {
	if (b) {
...
var $author$project$Sticks$singleStick = F2(
	function (side, num) {
		...
		var dur = $elm$core$String$fromFloat(0.75 + (num / 8)) + 's';
		return A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
...
var $author$project$Sticks$svgSticks = F3(
	function (anim, roll, op) {
		var clickable = A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
		...
		var contents = function () {
			if (roll.$ === 'Just') {
				...
				var side0 = $author$project$Sticks$retLight(r0 > 0);
				var side1 = $author$project$Sticks$retLight(r0 > 1);
				var side2 = $author$project$Sticks$retLight(r0 > 2);
				var side3 = $author$project$Sticks$retLight(r0 > 3);
	...
	var wscoreboard = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					'White: ' + $elm$core$Debug$toString(wpawn))
				]));
	}();
	var turn = A2(
		$elm$html$Html$h2,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Random moves')
						])),
					A2(
					$elm$html$Html$option,
					_List_fromArray(
						...
						_List_fromArray(
							[
								...
								function () {
									...
									if (_v1.$ === 'Just') {
										var r = _v1.a;
										return 'Roll: ' + $elm$core$Debug$toString(r);
									} else {
										return 'Roll!';
									}
								}())
						...
						_List_fromArray(
							[
								...
								function () {
									...
									if (_v2.$ === 'Just') {
										var s = _v2.a;
										return promotionImminent ? ('Promote pawn on square ' + $elm$core$Debug$toString(s + 1)) : ('Play pawn on square ' + $elm$core$Debug$toString(s + 1));
									} else {
	...
	var bscoreboard = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Black: ' + $elm$core$Debug$toString(bpawn))
				]));
	}();
	var header = A2(
		$elm$html$Html$div,
											...
											[
												...
												function () {
													...
													if (_v0.$ === 'Nothing') {
														...
														var r = _v0.a;
														return 'Threw a ' + $elm$core$String$fromInt(r);
													}
												}())
											])),
										A3(
