...
var $author$project$Docs$floatify = function (_v0) {
	var px = _v0.a;
	var py = _v0.b;
...
var $author$project$Docs$mag = function (_v0) {
	var px = _v0.a;
	var py = _v0.b;
	return $elm$core$Basics$sqrt((px * px) + (py * py));
};
var $author$project$Docs$norm = function (_v0) {
	var px = _v0.a;
	var py = _v0.b;
	var mag_ = $author$project$Docs$mag(
		_Utils_Tuple2(px, py));
	return _Utils_Tuple2((-py) / mag_, px / mag_);
};
var $elm$svg$Svg$path = $elm$svg$Svg$trustedNode('path');
var $author$project$Docs$sMul = F2(
	function (a, _v0) {
		var px = _v0.a;
		var py = _v0.b;
...
var $author$project$Docs$vAdd = F2(
	function (_v0, _v1) {
		var px = _v0.a;
		var py = _v0.b;
		var qx = _v1.a;
...
var $author$project$Docs$arrow = F2(
	function (_v0, _v1) {
		var x = _v0.a;
		var y = _v0.b;
		var w = _v1.a;
		var z = _v1.b;
		var vec = $author$project$Docs$floatify(
			_Utils_Tuple2(x - w, y - z));
		var nvec = A2(
			$author$project$Docs$sMul,
			10,
			$author$project$Docs$norm(vec));
		var len = $author$project$Docs$mag(vec);
		var setback = A2($author$project$Docs$sMul, 25.0 / len, vec);
		var pt1 = A2(
			$author$project$Docs$vAdd,
			$author$project$Docs$floatify(
				_Utils_Tuple2(w, z)),
			setback);
		var pt2 = A2($author$project$Docs$vAdd, pt1, nvec);
		var pt3 = A2(
			$author$project$Docs$vAdd,
			pt1,
			A2($author$project$Docs$sMul, -1.0, nvec));
		return _List_fromArray(
			[
				A2(
				$elm$svg$Svg$path,
...
var $author$project$Docs$boardDir = function () {
	...
	var rlen = 10;
	var length = 100;
	var getCornerPos = function (_v7) {
		var i = _v7.a;
		var j = _v7.b;
		return _Utils_Tuple2((j * length) + ((rlen / 2) | 0), (i * length) + ((rlen / 2) | 0));
	};
	var minisquare = function (_v6) {
		var i = _v6.a;
		var j = _v6.b;
		var _v5 = getCornerPos(
			_Utils_Tuple2(i, j));
		var x = _v5.a;
		var y = _v5.b;
		return A2(
...
var $author$project$Docs$convComb = F3(
	function (a, p, q) {
		return A2(
			$author$project$Docs$vAdd,
			A2($author$project$Docs$sMul, a, p),
			A2($author$project$Docs$sMul, 1 - a, q));
	});
var $author$project$Docs$cr = 35;
var $author$project$Docs$dotsFrom = F2(
	function (_v0, _v1) {
		var x = _v0.a;
		var y = _v0.b;
		var w = _v1.a;
		var z = _v1.b;
		var vec = $author$project$Docs$floatify(
			_Utils_Tuple2(w - x, z - y));
		var u = A2(
			$author$project$Docs$sMul,
			1 / $author$project$Docs$mag(vec),
			vec);
		var off = $author$project$Docs$cr + 5;
		var rp = A2(
			$author$project$Docs$vAdd,
			$author$project$Docs$floatify(
				_Utils_Tuple2(w, z)),
			A2($author$project$Docs$sMul, -off, u));
		var lp = A2(
			$author$project$Docs$vAdd,
			$author$project$Docs$floatify(
				_Utils_Tuple2(x, y)),
			A2($author$project$Docs$sMul, off, u));
		var pt1 = A3($author$project$Docs$convComb, 0.3, lp, rp);
		var pt2 = A3($author$project$Docs$convComb, 0.5, lp, rp);
		var pt3 = A3($author$project$Docs$convComb, 0.7, lp, rp);
		var circler = function (_v2) {
			var px = _v2.a;
			var py = _v2.b;
			return A2(
				$elm$svg$Svg$circle,
...
var $author$project$Docs$drawEdge = F2(
	function (_v0, _v1) {
		var x = _v0.a;
		var y = _v0.b;
		var w = _v1.a;
		var z = _v1.b;
		var off = $author$project$Docs$cr;
		var _v2 = (_Utils_cmp(y, z) < 0) ? _Utils_Tuple2(
			_Utils_Tuple2(x, y + off),
			_Utils_Tuple2(w, z - off)) : _Utils_Tuple2(
			_Utils_Tuple2(w, z + off),
			_Utils_Tuple2(x, y - off));
		var _v3 = _v2.a;
		var x1 = _v3.a;
		var y1 = _v3.b;
...
var $author$project$Docs$caption = F3(
	function (isLeft, _v0, str) {
		var x = _v0.a;
		var y = _v0.b;
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						isLeft ? 'start' : 'end'),
						$elm$svg$Svg$Attributes$fontFamily('serif'),
						$elm$svg$Svg$Attributes$fontSize('18pt')
					]),
				_List_fromArray(
					[
...
var $author$project$Docs$lcaption = $author$project$Docs$caption(true);
var $author$project$Docs$rcaption = $author$project$Docs$caption(false);
var $author$project$Docs$crs = '35';
var $elm$svg$Svg$Attributes$opacity = _VirtualDom_attribute('opacity');
var $author$project$Docs$treeNode = F3(
	function (_v0, color, str) {
		var x = _v0.a;
		var y = _v0.b;
		var yc = $elm$core$String$fromInt(y);
		var xc = $elm$core$String$fromInt(x);
		var lab = $elm$core$String$isEmpty(str) ? _List_Nil : _List_fromArray(
			[
				A2(
				$elm$svg$Svg$text_,
				_List_fromArray(
		...
		var circ = A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$stroke('black'),
					$elm$svg$Svg$Attributes$r($author$project$Docs$crs),
					$elm$svg$Svg$Attributes$cx(xc),
					$elm$svg$Svg$Attributes$cy(yc),
					$elm$svg$Svg$Attributes$opacity('45%')
				]),
			_List_Nil);
		return A2($elm$core$List$cons, circ, lab);
	});
var $author$project$Docs$treePic = function () {
	var width = 1600;
	var height = 500;
	var outline = A2(
		$elm$svg$Svg$rect,
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$y('0'),
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt(width - 1)),
				$elm$svg$Svg$Attributes$height(
				$elm$core$String$fromInt(height - 1))
			]),
		_List_Nil);
	var dropRow = function (_v0) {
		var x = _v0.a;
		var y = _v0.b;
		return _Utils_Tuple2(x, y + 100);
	};
	var cenx = (width / 2) | 0;
	var comments = _List_fromArray(
		[
			A2(
			$author$project$Docs$rcaption,
			_Utils_Tuple2(cenx - 560, 50),
			'Current State'),
			A2(
			$author$project$Docs$rcaption,
			_Utils_Tuple2(cenx - 560, 150),
			'My pawn choice'),
			A2(
			$author$project$Docs$rcaption,
			_Utils_Tuple2(cenx - 560, 250),
			'Stick toss'),
			A2(
			$author$project$Docs$rcaption,
			_Utils_Tuple2(cenx - 560, 350),
			'Their pawn choice'),
			A2(
			$author$project$Docs$rcaption,
			_Utils_Tuple2(cenx - 560, 450),
			'State evaluation'),
			A2(
			$author$project$Docs$lcaption,
			_Utils_Tuple2(cenx + 560, 450),
			'State evaluation'),
			A2(
			$author$project$Docs$lcaption,
			_Utils_Tuple2(cenx + 500, 300),
			'Minimum'),
			A2(
			$author$project$Docs$lcaption,
			_Utils_Tuple2(cenx + 400, 200),
			'Expectation'),
			A2(
			$author$project$Docs$lcaption,
			_Utils_Tuple2(cenx + 270, 100),
			'Maximum'),
			A2(
			$author$project$Docs$arrow,
			_Utils_Tuple2(cenx + 620, 430),
			_Utils_Tuple2(cenx + 550, 320)),
			A2(
			$author$project$Docs$arrow,
			_Utils_Tuple2(cenx + 530, 280),
			_Utils_Tuple2(cenx + 470, 220)),
			A2(
			$author$project$Docs$arrow,
			_Utils_Tuple2(cenx + 450, 180),
			_Utils_Tuple2(cenx + 350, 120)),
			A2(
			$author$project$Docs$arrow,
			_Utils_Tuple2(cenx + 260, 90),
			_Utils_Tuple2(cenx + 40, 50))
		]);
	var d1 = _Utils_Tuple2(cenx - 340, 250);
	var d2 = _Utils_Tuple2(cenx - 100, 250);
	var dd = _Utils_Tuple2(cenx + 100, 250);
	var de = _Utils_Tuple2(cenx + 340, 250);
	var e1 = _Utils_Tuple2((cenx - 340) - 150, 350);
	var e2 = _Utils_Tuple2((cenx - 340) - 50, 350);
	var e5 = _Utils_Tuple2((cenx - 340) + 150, 350);
	var ea = _Utils_Tuple2((cenx + 340) - 150, 350);
	var eb = _Utils_Tuple2((cenx + 340) - 50, 350);
	var ee = _Utils_Tuple2((cenx + 340) + 150, 350);
	var row3 = _List_fromArray(
		[
			A2($author$project$Docs$drawEdge, d1, e1),
			A2($author$project$Docs$drawEdge, d1, e2),
			A2($author$project$Docs$dotsFrom, e2, e5),
			A2($author$project$Docs$drawEdge, d1, e5),
			A3($author$project$Docs$treeNode, e1, 'snow', 'Pawn 1'),
			A3($author$project$Docs$treeNode, e2, 'snow', 'Pawn 2'),
			A3($author$project$Docs$treeNode, e5, 'snow', 'Pawn m'),
			A2($author$project$Docs$dotsFrom, e5, ea),
			A2($author$project$Docs$drawEdge, de, ea),
			A2($author$project$Docs$drawEdge, de, eb),
			A2($author$project$Docs$drawEdge, de, ee),
			A2($author$project$Docs$dotsFrom, eb, ee),
			A3($author$project$Docs$treeNode, ea, 'snow', 'Pawn 1'),
			A3($author$project$Docs$treeNode, eb, 'snow', 'Pawn 2'),
			A3($author$project$Docs$treeNode, ee, 'snow', 'Pawn m\'')
		]);
	var row4 = _List_fromArray(
		[
			A2(
			$author$project$Docs$drawEdge,
			e1,
			dropRow(e1)),
			A2(
			$author$project$Docs$drawEdge,
	...
	var root = _Utils_Tuple2(cenx, 50);
	var row0 = _List_fromArray(
		[
			_List_fromArray(
			[outline]),
			A3($author$project$Docs$treeNode, root, 'slategray', 's')
		]);
	var ce = _Utils_Tuple2(cenx + 220, 150);
	var c1 = _Utils_Tuple2(cenx - 220, 150);
	var row1 = _List_fromArray(
		[
			A2($author$project$Docs$drawEdge, root, c1),
			A2($author$project$Docs$drawEdge, root, ce),
			A3($author$project$Docs$treeNode, c1, 'slategray', 'Pawn 1'),
			A2($author$project$Docs$dotsFrom, c1, ce),
			A3($author$project$Docs$treeNode, ce, 'slategray', 'Pawn n')
		]);
	var row2 = _List_fromArray(
		[
			A2($author$project$Docs$drawEdge, c1, d1),
			A2($author$project$Docs$drawEdge, c1, d2),
			A2($author$project$Docs$drawEdge, ce, dd),
			A2($author$project$Docs$drawEdge, ce, de),
			A2($author$project$Docs$dotsFrom, d1, d2),
			A2($author$project$Docs$dotsFrom, d2, dd),
			A2($author$project$Docs$dotsFrom, dd, de),
			A3($author$project$Docs$treeNode, d1, 'mediumpurple', '1'),
			A3($author$project$Docs$treeNode, d2, 'mediumpurple', '5'),
			A3($author$project$Docs$treeNode, dd, 'mediumpurple', '1'),
			A3($author$project$Docs$treeNode, de, 'mediumpurple', '5')
		]);
	var objs = _Utils_ap(
		comments,
		_Utils_ap(
...
var $author$project$Main$view = function (model) {
	...
	var turn = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				function () {
					var _v7 = $author$project$Board$isOver(model.gs);
					if (_v7.$ === 'NotDone') {
	...
	var stringToMessage = F2(
		function (col, str) {
			switch (str) {
				case 'Human':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$Human);
				case 'AILast':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$AILast);
				case 'AIRand':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$AIRand);
				case 'AIFast':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$AIFast);
				case 'AIMed':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$AIMed);
				case 'AISlow':
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$AISlow);
				default:
					return A2($author$project$Main$ChangePlayer, col, $author$project$Main$Human);
			}
		});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value('AIRand')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Random pawn')
					...
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$x('0'),
								$elm$svg$Svg$Attributes$y('0'),
								$author$project$Main$href('images/afterlife.png'),
								$elm$svg$Svg$Events$onClick(
								$author$project$Main$Click(30))
							]),
						_List_Nil),
